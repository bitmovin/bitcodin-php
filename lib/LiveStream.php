<?php
    ...
    class LiveStream extends ApiResource
    {
         ...
         * @param  Output          $output
         * @param int              $timeshift
         * @param int              $liveEdgeOffset
         *
         * @return LiveStream
         */
        public static function create($label, $streamKey, $encodingProfile, $output, $timeshift = 30, $liveEdgeOffset = NULL)
        {
            $requestBody = json_encode(array(
                ...
                "streamKey"         => $streamKey,
                "timeshift"         => $timeshift,
                "liveEdgeOffset"    => is_null($liveEdgeOffset) ? 60 : $liveEdgeOffset
            ));
